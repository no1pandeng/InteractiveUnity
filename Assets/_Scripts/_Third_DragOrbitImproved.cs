...
public class _Third_DragOrbitImproved : MonoBehaviour
{
    ...
    public bool countingRelocate = false;
    public float timer = 0;
    public float timerGo = 0.5f;

    public float initial_Rot_X;
    public float initial_Rot_Y;
    float initial_dis;
    ...
    void Start()
    {
        ...
        //initial data
        initial_Rot_X = rotationXAxis;
        initial_Rot_Y = rotationYAxis;
        initial_dis = 50f;
    ...
    void Relocate()
    {
        if (countingRelocate)
        {
            ...
            {
                timer = 0;
                countingRelocate = false;
            }
        }
        if (Input.GetMouseButtonUp(2)){
            if (timer < timerGo && countingRelocate){
                print(timer.ToString());
                countingRelocate = false;
                rotationXAxis = initial_Rot_X;
                rotationYAxis = initial_Rot_Y;
                velocityX = 0.2f* velocityX;
                velocityY = 0.2f* velocityY;
                distance = initial_dis;
            }
        }
    }
